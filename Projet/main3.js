...
form.addEventListener("submit", function (event) {
    ...
    if (pseudo.value.length < 6) {
      ...
      let err = document.createElement("li");
      err.innerText = "Le champ pseudo ne peut pas être inférieur à 6 caractères";
    ...
    if (password.value.length < 10 || passCheck.test(password.value) === false) {
        ...
        let err = document.createElement("li")
        err.innerText = "Le champ mot de passe ne peut pas être inférieur à 10 caractères et doit contenir au moins une majuscule, une minuscule, un caractère spécial et un chiffre"
